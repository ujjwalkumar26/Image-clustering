...
class image_clustering:
	...
	def __init__(self, folder_path="data", n_clusters=10, max_examples=None, use_imagenets=False, use_pca=False):
		...
		del paths 
		print("\n output clusters folders created.")
	...
	def clustering(self):
		...
		for i in range(self.max_examples):
			shutil.copy2(self.folder_path+"\\"+self.image_paths[i], "Clusters\\cluster"+str(predictions[i]))
		print("\n Clustering complete! \n\n Clusters and the respective images are stored in the \"Clusters\" folder.")
